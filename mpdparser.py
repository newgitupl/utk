...
class MPDParser:
    ...
    def get_segment_template(self, adaptation_set, representation_index=0, video_type="480"):
    ...
    def get_segment_urls(self):
        ...
        video_template, vid_start_number_str, vid_init, vid_media, vid_timescale = self.get_segment_template(video_set, video_type="480")
